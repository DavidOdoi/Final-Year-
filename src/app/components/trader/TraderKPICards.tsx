...
export function TraderKPICards({ language, loads, isLoading = false }: TraderKPICardsProps) {
  const content = {
    sw: {
      ...
      totalHint: 'Jumla ya mizigo yote uliyoweka',
    },
    en: {
      ...
      totalHint: 'All loads you have posted',
    },
  };
  ...
  const cards = [
    ...
    {
      title: text.totalLoads,
      value: isLoading ? text.loading : String(loads.length),
      hint: text.totalHint,
      icon: Truck,
